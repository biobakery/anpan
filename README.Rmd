...
Once anpan is installed and the vignette is built, you can view the vignette with `vignette("anpan_tutorial", package = "anpan")`. Try `browseVignettes("anpan")` > "HTML" if you'd like to view it in a browser. There is also a static (and probably out-of-date) version of the tutorial available on [the biobakery wiki GitHub page](https://github.com/biobakery/biobakery/wiki/anpan_tutorial).
