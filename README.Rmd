...
If you would like to read the walkthrough vignette, you will need to set the `build_vignettes = TRUE` argument in the `install_github()` command, at which point you can view the vignette with `vignette("anpan_tutorial", package = 'anpan')`.
