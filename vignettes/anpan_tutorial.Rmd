...
You can see that the model fit confirms what we observed visually earlier: the phylogenetic effect generally shifts the outcome up on the left side and tightly correlated neighbors generally have very similar phylogenetic effects.
