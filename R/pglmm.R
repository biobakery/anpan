...
#'
#'   If a prior scale on covariate effects isn't specified (e.g. covariates are provided by
#'   \code{beta_sd} is left at the default NULL), the prior scale is set to 1 / (1 standard
